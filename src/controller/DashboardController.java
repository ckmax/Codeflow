...
public class DashboardController implements Initializable {
	...
	public void initializeTable(){
		...
		data =	FXCollections.observableArrayList(
		            new TableEntry("SPN","Software Engineering"),
		            new TableEntry("SPN2","Artificial Intelligence")
		        );
	   ...
	   info.setCellValueFactory(
                new PropertyValueFactory<TableEntry, String>("info"));
       ...
       Callback<TableColumn<TableEntry, String>, TableCell<TableEntry, String>> cellFactory = //
               ...
               {
                   public TableCell<TableEntry, String> call( final TableColumn<TableEntry, String> param )
                   {
                           ...
                           public void updateItem( String item, boolean empty )
                           {
                               ...
                               else
                               {
                                   btn.setOnAction( ( ActionEvent event ) ->
                                           {
                                               TableEntry person = getTableView().getItems().get( getIndex() );
	...
	public void removeBtn(){
		...
		TableEntry entryToBeRemoved = (TableEntry) tableView.getSelectionModel().getSelectedItem();
